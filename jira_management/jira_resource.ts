...
class JiraResource {
  ...
  async createVersion(projectName: string, versionName: string, description?: string): Promise<Record<string, unknown> | null> {
  ...
  async getLatestReleases(projectName: string, numReleases: number): Promise<{
