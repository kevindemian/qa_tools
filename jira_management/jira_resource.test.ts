...
describe('getJiraResource', () => {
  ...
  it('throws on network error', async () => {
    ...
    await expect(jiraResource.getJiraResource('project/TEST')).rejects.toThrow(
      'Network error',
    );
  });
  ...
  it('throws on axios error with status', async () => {
    ...
    (axiosErr as any).response = { status: 404, data: { message: 'Not Found' } };
    mockClient.get.mockRejectedValue(axiosErr);

    await expect(jiraResource.getJiraResource('project/UNKNOWN')).rejects.toThrow(
      'Not found',
    );
  });
});
...
describe('postJiraResource', () => {
  ...
  it('throws on API error', async () => {
    ...
    await expect(
      jiraResource.postJiraResource('version', {}),
    ).rejects.toThrow('API error');
  });

  it('logs error and re-throws on failure', async () => {
    const apiErr = new Error('Bad request');
    (apiErr as any).response = { status: 400 };
    mockClient.post.mockRejectedValue(apiErr);

    await expect(jiraResource.postJiraResource('version', {})).rejects.toThrow(
      'Bad request',
    );
  });
});
...
describe('putJiraResource', () => {
  ...
  it('throws on API error', async () => {
    ...
    await expect(
      jiraResource.putJiraResource('version/10001', {}),
    ).rejects.toThrow('API error');
  });

  it('logs error and re-throws on failure', async () => {
    const apiErr = new Error('Forbidden');
    (apiErr as any).response = { status: 403 };
...
describe('getProjectId', () => {
  ...
  it('throws when project not found', async () => {
    ...
    await expect(jiraResource.getProjectId('UNKNOWN')).rejects.toThrow(
      'Project not found',
    );
  });
  ...
  it('throws on network error', async () => {
    ...
    await expect(jiraResource.getProjectId('TEST')).rejects.toThrow(
      'ECONNREFUSED',
    );
  });
});
...
describe('getProjectVersions', () => {
  ...
  it('throws on API error', async () => {
    ...
    await expect(jiraResource.getProjectVersions('999')).rejects.toThrow(
      'Not found',
    );
  });
...
describe('searchJiraIssues', () => {
  ...
  it('propagates error from getJiraResource', async () => {
    ...
    await expect(
      jiraResource.searchJiraIssues('project = TEST'),
...
describe('createVersion', () => {
  ...
  it('handles post failure gracefully', async () => {
    ...
    await expect(
      jiraResource.createVersion('TEST', 'v1.0'),
    ).rejects.toThrow('API error');
  });
});
...
describe('checkReleaseTasksStatus', () => {
  ...
  it('propagates error from getProjectId', async () => {
    jest
      .spyOn(jiraResource, 'getProjectId')
      .mockRejectedValueOnce(new Error('Project error'));

    await expect(
      jiraResource.checkReleaseTasksStatus('TEST', 'v1.0'),
...
describe('getReleaseTasks', () => {
  ...
  it('propagates error from getProjectId', async () => {
    ...
    await expect(
      jiraResource.getReleaseTasks('TEST', 'v1.0'),
    ).rejects.toThrow('Project error');
  });
});
...
describe('addTasksToSprint', () => {
  ...
  it('handles error gracefully without throwing', async () => {
    ...
    await expect(
      jiraResource.addTasksToSprint(['TASK-1'], 'sprint-1'),
...
describe('updateFixVersions', () => {
  ...
  it('propagates put error', async () => {
    ...
    await expect(
      jiraResource.updateFixVersions(['TASK-1'], 'TEST', 'v1.0'),
...
describe('releaseVersion', () => {
  it('releases version successfully', async () => {
    jest.spyOn(jiraResource, 'getVersionId').mockResolvedValueOnce('v-1');
    jest
      .spyOn(jiraResource, 'checkReleaseTasksStatus')
  ...
  it('propagates put error', async () => {
    ...
    await expect(
      jiraResource.releaseVersion('TEST', 'v1.0'),
...
describe('moveCardsToDone', () => {
  beforeEach(() => {
    jest.spyOn(jiraResource, 'transitionIssue').mockResolvedValue();
  });
  ...
  it('moves through coding in progress workflow', async () => {
    ...
    await jiraResource.moveCardsToDone(['TASK-1']);
    expect(jiraResource.transitionIssue).toHaveBeenCalledTimes(2);
    expect(jiraResource.transitionIssue).toHaveBeenNthCalledWith(1, 'TASK-1', '51');
    expect(jiraResource.transitionIssue).toHaveBeenNthCalledWith(2, 'TASK-1', '61');
  });
  ...
  it('skips specific transition when transition id not found', async () => {
    ...
    expect(jiraResource.transitionIssue).toHaveBeenCalledWith('TASK-1', '31');
  });
  ...
  it('processes multiple tasks independently', async () => {
    ...
    expect(jiraResource.transitionIssue).toHaveBeenCalledTimes(2);
    expect(jiraResource.transitionIssue).toHaveBeenNthCalledWith(1, 'TASK-1', '31');
    expect(jiraResource.transitionIssue).toHaveBeenNthCalledWith(2, 'TASK-3', '71');
  });
  ...
  it('handles API error during transition gracefully', async () => {
    ...
    (jiraResource.transitionIssue as jest.Mock).mockRejectedValue(
      new Error('API error'),
    );

    await expect(
      jiraResource.moveCardsToDone(['TASK-1']),
...
describe('transitionIssue', () => {
  ...
  it('handles error gracefully without throwing', async () => {
    ...
    await expect(
      jiraResource.transitionIssue('TASK-1', '31'),
    ).resolves.toBeUndefined();
  });
