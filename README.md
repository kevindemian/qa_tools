...
└── config/             ← config opcional legada (reviewers, features)
```
...
| [Projetos (multi-projeto)](docs/07-projetos-registry.md) | Selecionar, adicionar e gerenciar projetos; `--project` / `--dir`; migração de config antiga         |
