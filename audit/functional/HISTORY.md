# QA Tools — Functional Audit History

> **Histórico completo de auditoria funcional.** Contém gaps individuais, D7 Deep Test Audit,
> D8-D12 Delta Audit, e registros de decisão por feature (FT-01 a FT-32).
>
> Para status atual consolidado, veja `PROGRESS.md`. Para plano executável, veja `SYSTEMIC-CORRECTION-PLAN.md`.
> Para regras de execução, veja `SOP.md`.
