...
| 22    | Consumer Migration + SSOT Centralization | ⚠️ INCORRETO — 35 bypasses. Ver [SSOT-ENFORCEMENT-PLAN] |
| 23-26 | Integration / Tests / Audit              | 🔜 Absorvido pelo [SSOT-ENFORCEMENT-PLAN]               |

[SSOT-ENFORCEMENT-PLAN]: data-hub-ssot-enforcement.md
...
> ⚠️ **CORREÇÃO (2026-07-09):** Phase 22 foi marcada como ✅ Done mas auditoria exaustiva encontrou **35 bypasses em 28 arquivos de produção**. A falsa conclusão foi causada por:
>
> - Health-score, quality-gate, pr-report-core foram modificados mas continuam com bypasses (DataHub.computed ignorado)
> - 18 sites ainda acessam `store.runs` diretamente via `loadMetricsStore()`
> - session-context.ts nunca foi migrado (continua usando `Store` legacy)
> - ci-test-downloader.ts, coverage-source.ts foram **completamente ignorados** (0 commits)
> - Dead code (test-count-extractor.ts) e TS2307 (case17-test-utils.ts) não foram resolvidos
>
> **Plano de correção:** [`shared/plans/data-hub-ssot-enforcement.md`](data-hub-ssot-enforcement.md) — 10 fases com checkpoints testáveis.
...
> ⚠️ **CORREÇÃO (2026-07-09):** Este sprint foi iniciado mas NUNCA concluído — todos os itens G1-G7 continuam 🔜 Pendente.
> A correção real foi transferida para [`shared/plans/data-hub-ssot-enforcement.md`](data-hub-ssot-enforcement.md)
> que contém um plano completo de 10 fases com checkpoints testáveis.
...
## Phase 23-26 — Absorvido pelo SSOT Enforcement Plan

> **Decisão (2026-07-09):** Os planos originais para Phases 23-26 foram absorvidos pelo
> [`shared/plans/data-hub-ssot-enforcement.md`](data-hub-ssot-enforcement.md) que contém:
>
> - Fase 0-7: Migração completa dos 35 consumidores conhecidos
> - Fase 8: Deleção de fontes alternativas (ci-test-downloader, coverage-source, commit-log)
> - Fase 9: Captura de consumidores silenciosos
> - Fase 10: Prevenção (ESLint + TECHDOC + verificação final)
