...
import { showSelect, info, warn, smartPrompt } from './prompt.js';
...
export interface MenuUI {
    ...
    /** Legacy surface kept optional for test compatibility (pre-menu flows removed). */
    confirm?: (message: string, defaultYes?: boolean) => boolean;
    divider?: () => void;
}
