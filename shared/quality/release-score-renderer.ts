...
export function generateReleaseScoreHtml(result: ReleaseScoreResult | null | undefined, generatedAt?: string): string {
    if (!result) {
...
function wrapContainer(pageTitle: string, children: string, generatedAt?: string): string {
