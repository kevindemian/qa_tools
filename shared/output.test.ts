...
describe('Output', () => {
    ...
    it('rows returns stdout.rows or 24', async () => {
    ...
    it('columns returns stdout.columns or 80', async () => {
    ...
    it('isTTY returns stdout.isTTY', async () => {
    ...
    it('defaultOutput is an Output instance', async () => {
