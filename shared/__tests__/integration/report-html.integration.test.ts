...
describe('Integration: HTML Report (FT-17)', () => {
    ...
    describe('FT-17a: generateHtmlReport', () => {
        it('returns complete HTML document', async () => {expect.hasAssertions();
        ...
        it('handles empty test array gracefully', async () => {expect.hasAssertions();
        ...
        it('includes health score section when provided', async () => {expect.hasAssertions();
        ...
        it('includes quality gate section when gate fails', async () => {expect.hasAssertions();
        ...
        it('renders multi-run tabs', async () => {expect.hasAssertions();
    ...
    describe('FT-17b: generateCoverageHtml', () => {
        ...
        it('shows per-epic close percentage', async () => {expect.hasAssertions();
    ...
    describe('FT-17d: generateCoverageHtml with empty epics', () => {
        it('handles empty epics gracefully', async () => {expect.hasAssertions();
