/**
 * Compute: Requirement Quality Score — evaluates testability of requirements
 * based on AI feedback analysis. Correlates acceptance rates, modification
 * patterns, and prompt version effectiveness to produce a quality score per
 * requirement.
 *
 * Pure compute layer. No presentation logic.
 * Render layer: shared/quality/requirement-score-renderer.ts (deleted in a
 * later phase).
 *
