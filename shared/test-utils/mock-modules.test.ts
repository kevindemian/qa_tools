...
describe('Mock Modules', () => {
    ...
    describe('Mock Git Provider Error', () => {
        ...
        it('handleError returns null with returnNull: true', () => {
            const mock = mockGitProviderError();
            const result = mock.handleError(new Error('test'), { returnNull: true });

            expect(result).toBeNull();
        });

        it('handleError throws error without returnNull', () => {
            const mock = mockGitProviderError();
