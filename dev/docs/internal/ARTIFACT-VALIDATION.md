...
1. **Estado atual:** Fase A concluída (primitives) · Plan v2 registrado (§7) · F1-T1 (B1) ✅ · F1-T2 (B2) ✅ · F1-T3 (B3 merge release-score) ✅ · F1-T4 (Layer 7 SSOT) ✅ · F1-T5 (revisão call-sites `createDataHub*`) ✅ · F0-T1 (B4+B22 — pr-report computado-driven) ✅ · F0-T2 (remover `statsFromTests`) ✅ · **Próxima: F0-T3..T5** — ver PROGRESS abaixo.
