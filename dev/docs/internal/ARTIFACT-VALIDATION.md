...
1. **Estado atual:** Fase A concluída (primitives) · Plan v2 registrado (§7) · F1-T1 (B1) ✅ · F1-T2 (B2) ✅ · F1-T3 (B3 merge release-score) ✅ · F1-T4 (Layer 7 SSOT) ✅ · **Próxima: F1-T5** — ver PROGRESS abaixo.
...
| — | F1-T5 a F7 | ⏳ PENDENTE | seguir §8/§7 |
