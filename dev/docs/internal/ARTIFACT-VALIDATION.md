...
| — | F6-T2/T3 (schedule/interactive `buildHtmlPage`) | ⏳ PENDENTE | D3 ✅ |
...
| Pendentes verificado no código | F0-T6, F0-T7, F0-T11 ✅, F0-T12 ✅, F2, F3 ✅, F4, F6-T2/T3, F7 | `schedule-handler.ts:182/183`, `interactive-mode.ts:570`, `pr-report-core.ts:89`, `report-sections.ts` 8x `return ''`, AQS ausente. ~~`pipeline-health-renderer.ts:49/75/97/140-143`~~ → **I-8 ✅ (2026-08-04)** |
...
- `I-8.2` schedule/interactive dashboards -> `buildHtmlPage` (F5-T2 a11y). ⏳ PENDENTE
