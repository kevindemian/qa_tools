...
describe('GitHubManager', () => {
    ...
    describe('GetMergeRequest', () => {
        ...
        it('returns null on 404 (not found)', async () => {
            ...
            mockClient.get.mockRejectedValue(Object.assign(new Error('Not Found'), { response: { status: 404 } }));
    ...
    describe('SearchMergeRequests', () => {
        ...
        it('returns [] on 404 (not found)', async () => {
            expect.hasAssertions();
    ...
    describe('IsApproved', () => {
        ...
        it('returns false on 404 (not found)', async () => {
            expect.hasAssertions();
