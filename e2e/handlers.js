...
function setupHandlers() {
  ...
  jira.get('/issue/TEST-1').times(2).reply(200, { key: 'TEST-1', fields: { description: '', customfield_13708: [] } });
...
module.exports = { setupHandlers, resetHandlers };
